...
public abstract partial class Character : CharacterBody2D
{
    ...
    public bool EnemyIsHighHealth()
    {
        return otherCharacter.IsHighHealth();
    }

    public bool EnemyIsLowHealth()
    {
        return otherCharacter.IsLowHealth();
    }
}